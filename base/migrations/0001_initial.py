...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            managers=[
                ('objects', base.models.managers.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='DefaultConf',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inchi_key', models.CharField(db_index=True, default=None, max_length=27, unique=True)),
                ('mol_rdkit', django_rdkit.models.fields.MolField(default=None)),
                ('smiles_with_limit', models.CharField(db_index=True, default='', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('molecule', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='base.Molecule')),
                ('parent_process', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.ProjectProcess')),
            ],
        ),
        migrations.CreateModel(
            name='SampleAnnotationProject',
            fields=[
                ('project_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='base.Project')),
                ('depth_total', models.IntegerField(default=0)),
                ('depth_last_match', models.IntegerField(default=0)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_base.project_set+', to='contenttypes.ContentType'),
        ),
        migrations.AddField(
            model_name='project',
            name='user',
