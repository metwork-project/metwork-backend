...
from fragmentation.models import FragAnnotation, FragAnnotationDB, FragAnnotationCompare, FragMolSample, FragSample
...
class FragAnnotationModelTests(TransactionTestCase):
	...
	def eval_import_file_annotation(self, file_format, sample_file_path, annotation_file_path, expected_res, user):
