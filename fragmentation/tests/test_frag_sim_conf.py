...
class FragSimConfModelTests(TransactionTestCase):
    ...
    def test_file_path(self):
        ...
        self.assertEqual(fsc.file_path('param'), FragSimConf.CFM_ID_FOLDER + 'param/param_output0.log')
        self.assertEqual(fsc.file_path('conf'), FragSimConf.CFM_ID_FOLDER + 'conf/param_config.txt')
